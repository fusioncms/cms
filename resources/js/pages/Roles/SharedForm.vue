    ...
    <div>
        <portal to="actions">
            <div class="buttons">
                ...
                <ui-button v-if="!isOwner" key="save-btn" type="submit" @click.prevent="submit" variant="primary" :disabled="!form.hasChanges || loading">Save</ui-button>
            </div>
        </portal>

        <section-card title="Loading..." v-show="loading"></section-card>               <div v-show="! loading">
