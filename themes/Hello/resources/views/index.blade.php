...
@section('content')
    <div class="text-center items-center justify-center flex flex-col flex-1">
        <h1 class="text-6xl font-bold text-gray-700 tracking-wider leading-tight">{{ theme('value.greeting') ?? 'Welcome to FusionCMS' }}</h1>

        <p class="tracking-wide font-medium text-gray-600 mt-3">{{ theme('value.message') ?? 'We think you\'ll enjoy your time here' }}</p>
