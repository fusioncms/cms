...
@section('content')
    <div class="text-center items-center justify-center flex flex-col flex-1">
        <h1 class="text-4xl md:text-6xl font-bold text-gray-700 tracking-wider leading-tight">{{ theme('value.homepage.greeting') ?? 'Welcome to FusionCMS' }}</h1>

        <p class="tracking-wide leading-loose text-gray-500 mt-6">{{ theme('value.homepage.message') ?? 'We think you\'ll enjoy your time here' }}</p>
